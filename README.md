...
I have a B.Sc. in Computer Engineering, a lot of curiosity and drive, and a knack for digesting new tech. I've worked in both startup and multinational enterprise environments, and I'm constantly looking to explore new domains.

* 💼  Daily work these days is changing tires on a complex moving vehicle at a Brazilian tech startup that leverages IoT to monitor and automate HVAC systems.
* 🎖️  Experience with event-driven architectures and microservices in Rust and TypeScript, plus Python for scripting.
* ⚙️  I like to use real-world work to challenge and refine my theoretical foundation in Software Engineering (OOP, SOLID, design patterns, architectural patterns, and such).
* 🧠  Continuously expanding my knowledge of and applying Domain-Driven Design (DDD) and Hexagonal Architecture.
* 💬  I'm passionate about sharing my skills with the team, whether it's through talks or mentoring.
* 🗒️  I naturally produce documentation as I learn, create thoughtful diagrams, and communicate tough technical concepts to the team and leadership.
* 🌎  I'm fluent in English.
* 🤝  Feel free to get in touch about collaborations, or just for networking!
* ❓  I used to play guitar in a rock band. You can listen to our sound [here](https://open.spotify.com/album/65oAcgzLzLTQvCqhYjRyBE?si=_mOu-b_kSICuLtPWS8iIhw) (it's in Portuguese).
...
<a href="http://www.github.com/savvyserg"><img src="https://github-stats-extended.vercel.app/api?username=savvyserg&count_private=true&show_icons=true&theme=tokyonight" alt="savvyserg's GitHub stats" /></a>
<a href="https://github.com/savvyserg" align="left"><img src="https://github-stats-extended.vercel.app/api/top-langs/?username=savvyserg&layout=compact&theme=tokyonight" alt="Top Languages" /></a>
